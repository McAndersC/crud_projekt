...
// Get Users - Her henter vi vores brugerer fra vores bruger fil.
...
users.updateUser = (payload, callback) => {
   ...
   */
    ...
    return callback(200, {'response' : `Updatér bruger med brugernavn: ${username} eventuelt med ny mailadresse ${email}`})
...
users.deleteUser = (payload, callback) => {
   ...
   */
    ...
    return callback(200, {'response' : `Slet bruger med brugernavn: ${username}`})
